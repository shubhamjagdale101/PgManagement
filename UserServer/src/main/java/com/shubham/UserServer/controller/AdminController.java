...
public class AdminController {
    ...
    @PostMapping("/addRoom")
    public ResponseEntity<String> addRoomToList(@Valid @RequestBody AddRoom addRoom){
    ...
    @GetMapping("/getUsers")
    public ResponseEntity<List<Object>> getAllUsers(@RequestParam("page") Integer page, @RequestParam("size") Integer size){
        return adminService.getAllUsers(page, size);
    }

    @PostMapping("/sendMessageToEveryOne")
    public ResponseEntity<String> sendMessageToEveryOne(@RequestBody MessageRequest messageRequest) throws Exception {
